...
#include "my_service_interfaces/srv/detail/reset_counter__rosidl_typesupport_fastrtps_c.h"
...
using _ResetCounter_Request__ros_msg_type = my_service_interfaces__srv__ResetCounter_Request;
...
size_t get_serialized_size_my_service_interfaces__srv__ResetCounter_Request(
  const void * untyped_ros_message,
...
static uint32_t _ResetCounter_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_service_interfaces__srv__ResetCounter_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t max_serialized_size_my_service_interfaces__srv__ResetCounter_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_service_interfaces__srv__ResetCounter_Request;
    is_plain =
      (
...
static size_t _ResetCounter_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_service_interfaces__srv__ResetCounter_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_service_interfaces, srv, ResetCounter_Request)() {
...
using _ResetCounter_Response__ros_msg_type = my_service_interfaces__srv__ResetCounter_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t get_serialized_size_my_service_interfaces__srv__ResetCounter_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ResetCounter_Response__ros_msg_type * ros_message = static_cast<const _ResetCounter_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_service_interfaces__srv__ResetCounter_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t max_serialized_size_my_service_interfaces__srv__ResetCounter_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_service_interfaces__srv__ResetCounter_Response;
    is_plain =
      (
...
static size_t _ResetCounter_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_service_interfaces__srv__ResetCounter_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_service_interfaces, srv, ResetCounter_Response)() {
...
// already included above
// #include "my_service_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_service_interfaces/srv/reset_counter.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_service_interfaces, srv, ResetCounter)() {
